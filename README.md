...
Junior Fullstack Developer at **Adianta Jus**, working on a LegalTech platform for court-ordered
payments (*precatórios*) — frontend, backend, data validation and application architecture.

Day to day I ship **2–3 features, fixes and refactors per week** from Jira tickets and Figma specs,
and I'm part of the ongoing migration of the product toward a more scalable architecture.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:ffffff,100:ecab23&height=100&section=footer" width="100%" />
